 ...
 * @author User
 */
public class DailyReceipts extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyReceipts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadDailySalesReport() {
        try{
		InputStream stream = getClass().getResourceAsStream(("/projectReports/amountReceivedPerTransaction.jrxml"));
