...
public class MyCalculator extends Dialog {
	...
	// /////////////////////////
	public MyCalculator(JFrame frame, String frameText)// constructor
	{
		super(frame, frameText, true);
		setResizable(false);
		int tempX = TOPX, y = TOPY;
		displayLabel.setFont(new Font("Dialog", Font.BOLD, 13));
		displayLabel.setBounds(tempX, y, 240, HEIGHT);
		displayLabel.setBackground(Color.decode("#5AD5D5"));
		...
		setLayout(null);
		setMinimumSize(new Dimension(296, 325));
		setPreferredSize(new Dimension(296, 325));
		setResizable(false);
